...
def get_connected_bool_sides(tile, row=None, col=None, grid_size=(None, None)):
    """
...
def has_any_connected_sides(tile, row=None, col=None, grid_size=(None, None)):
    ...
    return any(get_connected_bool_sides(tile, row, col, grid_size))


def get_locked_bool_sides(tile, row, col, grid_size):
    """
    ...
    locked_sides = get_connected_bool_sides(tile, row, col, grid_size)
...
def generate_new_bool_sides(tile, row, col, grid_size):
    """
    ...
    locked_sides = get_locked_bool_sides(tile, row, col, grid_size)
...
def always_generate_new_bool_sides(tile, row, col, grid_size, min_new_sides=1):
    """
    Generate a list of which sides to newly connect.
    ...
    count_locked_sides = sum(get_locked_bool_sides(tile, row, col, grid_size))
    ...
    while count_new_sides is None or count_new_sides < min_new_sides:
        ...
        new_sides = generate_new_bool_sides(tile, row, col, grid_size)
